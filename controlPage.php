		...
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				<button type="button" class="navbar-toggle" data-toggle="collapse"
					...
					<span class="sr-only">Toggle navigation</span> القائمة <i
						class="fa fa-bars"></i>
				</button>
				<a class="navbar-brand page-scroll" href="index.html#page-top"><img
					src="saai.png" alt="هوية ساع" class="logo" /></a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="page-scroll" href="index.html#portfolio">أرسل رسالة</a>
					</li>
					<li><a class="page-scroll" href="index.html#services">عن ساعٍ</a></li>

					<li><a class="page-scroll" href="controlPage.php">قائمة أرقامي</a>
					</li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		...
		<div class="container formSection">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">قائمة أرقامي</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form name="sign" id="signForm" novalidate>
						<div class="col-md-12">
							...
							<div class="form-group">
								<div class="col-lg-12 text-center">
									<div id="success"></div>
									<table border="0" width="400" style="margin: 0 auto;">
										<thead>
											<tr>
												<th>أرقام الواتس اب</th>

												<th>أرقام تيليجرام</th>

												<th>أرقام الرسائل النصية</th>
											</tr>
										</thead>
										<tbody>
   <?php
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="list-inline social-buttons">
						<li><a href="https://github.com/Sa3y/saay" target><i
